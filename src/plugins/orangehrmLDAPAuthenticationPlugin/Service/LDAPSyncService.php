...
class LDAPSyncService
{
    ...
    public function fetchAllLDAPUsers(): array
    {
        $ldapUsers = [];
        $duplicateUsernames = [];
        ...
        foreach ($this->fetchEntryCollections()->getCollections() as $entryCollectionLookupSettingPair) {
            foreach ($entryCollectionLookupSettingPair->getCollection()->toArray() as $entry) {
                ...
                if (isset($ldapUsers[$username])) {
                    ...
                    $usersOfDuplicateUsernames[$username][] = $ldapUser; // TODO::check this
                } else {
        ...
        return [$ldapUsers, $duplicateUsernames, $usersOfDuplicateUsernames, $failedUsers];
    }
    ...
    private function prepareLDAPUserFromEntry(
        ...
        try {
            ...
            return (new LDAPUser())
                ...
                ->setUserEnabled($this->getAttribute($entry, $dataMapping->getUserStatusAttribute()))
