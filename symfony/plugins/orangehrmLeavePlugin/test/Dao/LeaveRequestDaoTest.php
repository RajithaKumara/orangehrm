...
class LeaveRequestDaoTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fixtureFile = Config::get(Config::PLUGINS_DIR)
            . '/orangehrmLeavePlugin/test/fixtures/LeaveRequestDao.yml';
        TestDataService::populate($this->fixtureFile);
    ...
    public function testGetLeaveById(): void
    {
        ...
        $this->assertEquals('2010-09-01', $leave->getDecorator()->getLeaveDate());
    ...
    public function testGetEmployeesInSubUnits(): void
    {
    ...
    {
        $empNumbers = [];
        $employees = TestDataService::loadFixtures($this->fixtureFile, 'Employee');
    ...
    {
        $leaveRequests = [];
        $allLeaveRequests = TestDataService::loadFixtures($this->fixtureFile, 'LeaveRequest');
